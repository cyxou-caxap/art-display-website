            ...
            <div class="row add-post">
                ...
                <input value = "<?=$id?>" name="id" type="hidden">
                    ...
                    <label for="content" class="form-label">Название категории</label>
                        <input value = "<?=$name?>" name="name" type="text" class="form-control" placeholder="Название категории" aria-label="Название категории" required>
                    </div>
                    ...
                    <button name="categories-edit" class="button-row" type="submit">Обновить</button>
                </form>   
            </div>
        </div>
    </div>
